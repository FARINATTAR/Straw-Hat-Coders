  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <button onClick={onRefresh} className="flex items-center justify-center gap-2 px-4 py-2 bg-white sm:bg-transparent border border-slate-200 sm:border-transparent text-slate-500 rounded-xl hover:bg-slate-100 transition text-sm font-medium cursor-pointer">
